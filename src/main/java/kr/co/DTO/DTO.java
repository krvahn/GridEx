...
public class DTO {
	...
	public String getFrst_regiser_id() {
		return frst_regiser_id;
	}
	public void setFrst_regiser_id(String frst_regiser_id) {
		this.frst_regiser_id = frst_regiser_id;
	}
